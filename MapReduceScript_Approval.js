    ...
    (email, search,record) => {
        ...
        const getInputData = (inputContext) => {
                return search.create({
                        ...
                        columns: ['tranid','customer.email'],
                        title: 'Pending Approval SO'
                });
        ...
        const reduce = (reduceContext) => {
            ...
            email.send({
                ...
                recipients: -5,
                subject: 'updated',
                body: `${{salesorderid}} is updated`,
            });
            reduceContext.write({key:salesorderid});
        ...
        const summarize = (summaryContext) => {
            summaryContext.output.iterator().each(function(key) {
